...
import com.example.flyreserve.MainActivity;
import com.example.flyreserve.R;
import com.example.flyreserve.changepass;
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            String Form = dataSnapshot1.child("From").getValue().toString();
                            String To = dataSnapshot1.child("To").getValue().toString();
                            String id = dataSnapshot1.child("uid").getValue().toString();
                            Toast.makeText(profileview.getContext(), "Id is: " + id + " From: " + Form + " To " + To, Toast.LENGTH_LONG).show();
