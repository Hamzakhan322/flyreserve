...
import com.example.flyreserve.R;
...
public class adpter extends FirebaseRecyclerAdapter<model,adpter.Holder> {
    ...
    protected void onBindViewHolder(@NonNull final Holder holder, int i, @NonNull model model) {
        ...
        holder.dest.setText(model.getDestination());
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()) {
                            ...
                            final String cl=dataSnapshot.child(id).child("current").getValue().toString();
                            final String dl=dataSnapshot.child(id).child("destination").getValue().toString();
    ...
    public class Holder extends RecyclerView.ViewHolder {
        TextView current,dest,price,quantity;
        public Holder(@NonNull View itemView) {
            super(itemView);
            current=itemView.findViewById(R.id.currentTV);
